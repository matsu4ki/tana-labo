    ...
    <Layout location={location} title={siteTitle}>
      ...
      <div class="case">
        ...
        <div class="pj-task">
          ...
          <br/>
          <p>本事象を解決すべく、次のような点に留意しながら、課題解決に従事した。</p>
        </div>
        ...
        <div class="role">
          ...
          <p>プロダクトオーナー側に立ち、クライアント先の他部署を巻き込みながら、要件定義、開発チーム調整、本番リリースまでを一気通貫で対応。</p>
          ...
          <p>チーム立ち上げ後は、バグ数/問合せ数/納期遵守などの指標をモニタリングし、自律的に改善サイクルが作れるようKPTを根付かせた。</p>
