    ...
    <Layout location={location} title={siteTitle}>
      ...
      <div class="case">
        ...
        <div class="role">
          ...
          <p>1. クライアントが抱える課題の洗い出しと共有（上記のとおり）</p>
          <p>2. 円滑な業務推進に向けたキーパーソンとの信頼関係を構築</p>
          <p>3. 事業部長と共同でクライアントへの提案資料を作成</p>
          <br/>
          <p><b>■ 要望に応えられる開発チームを構築</b></p>
          <p>日々挙げられる改善要望にスピード感をもって対応するため、関係部署と調整して改善専門チームを立ち上げ、PJの開発スピードUPに寄与。</p>
          <p>チーム立ち上げ後は、様々な指標(バグ/問合せ/納期)をモニタリングしながら、振返りの場を設け、都度改善が出来るようにチームをマネジメント。</p>
          <p>また将来クライアント先の担当者に引継ぐため、業務フローやルール策定。</p>
          <br/>
          <p><b>■ 会社間を跨いだディレクション業務</b></p>
          <p>クライアント先の他部署を巻き込みながら、要望のヒアリングから要件の整理、開発チームとの調整、本番リリースまでを一気通貫で対応。</p>
          <p>クライアント側の受入時には、問合せの窓口対応と報告されるバグ対応の優先度を見極め、品質に配慮しつつ、納期の厳守に尽力した。</p>
          <br/>
          <p><b>■ 持続可能なチーム開発のための人材マネジメント</b></p>
          <p>開発チーム全体を俯瞰し、各メンバーのモチベーションを損わせない、かつ、PJの利益に繋がる提案（主に人員配置）と実行に尽力した。</p>
