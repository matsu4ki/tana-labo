  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <div class="case">
        ...
        <div class="pj-task">
          <p>クライアント企業は、土木建築の事業ドメインに強みをもっていたが、開発リソースやノウハウに乏しく、次のような課題を抱えていた。</p>
          <br/>
        ...
        <div class="role">
          ...
          <br/>
          <p><b>■ 技術調査を主体的リード</b></p>
          <p>PHP経験者が乏しかったので、環境構築 〜 試験手順策定を主体的にリードし、タイトなスケジュールを遅延させることなく、納期に間に合わせた。
          </p>
          <br/>
          <p><b>■ 単体試験の導入とルール策定</b></p>
          <p>
            単体試験の文化が無かったのでPHPUnitを導入し、運用ルールを策定することで、カバレッジ率の向上に努めた。
            結果的に結合試験で頻発していた単体レベルのバグを大きく減少させることに貢献した。</p>
        </div>
        <div class="previous">
